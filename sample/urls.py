...
urlpatterns = [
    ...
    url(r'^listing/view/(?P<listing_id>[0-9+])$', listingsView.viewDetail, name='viewListingDetails'),
    url(r'^listing/delete/(?P<listing_id>[0-9+])$', listingsView.delete, name='deleteListing'),
